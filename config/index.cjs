...
const USER_CONFIG = {
  ...
  APP_SECRET: 'ce45355538918ce381eb8af97e424c57',
  ...
  USERS: [
    {
      ...
      useTemplateId: '0mbZtZKVW2L6nyV4S_V55_J68VPoypbDh26X9olrr_4',
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2024-03-17' },
        // 结婚纪念日
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oxKGd6MBl1FOqnyOuwA0DxnoZUtg',
    }
  ],
